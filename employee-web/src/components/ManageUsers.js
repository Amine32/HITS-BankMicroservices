...
function ManageUsers() {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:8080/user/api/users', {withCredentials: true})
    ...
    const handleBlockToggle = (userId, isActive) => {
        ...
        axios.put(`http://localhost:8080/user/api/users/${userId}/block`, {isActive: !isActive}, {withCredentials: true})
            .then(() => {
